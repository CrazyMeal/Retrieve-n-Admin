...
/**
 * Netty Handler which expect to receive a JSON holding a set of Changes, and try to apply them
 * @author Denaux Robin
 */
public class ApplyChanges extends SimpleChannelInboundHandler<Object> {

    //buf hold the request
    private final StringBuilder req = new StringBuilder();
    ...
    protected void messageReceived(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof HttpContent) {
            ...
            if (content.isReadable()) {
                req.append(content.toString(CharsetUtil.UTF_8));
            }
    ...
    private boolean writeResponse(HttpObject currentObj, ChannelHandlerContext ctx) {
        ...
        Main.timeAtApply = new Date();
        Main.regionMover.computeChanges(req.toString());
        ...
        FullHttpResponse response = new DefaultFullHttpResponse(
                ...
                Unpooled.copiedBuffer(rep.toString(), CharsetUtil.UTF_8));
